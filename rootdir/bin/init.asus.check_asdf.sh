...
#for 32bit apk
cp /data/vendor/BBY/32bit_apk.cdn /data/system
chown system:system /data/system/32bit_apk.cdn

cmd game downscale 0.7 com.miHoYo.GenshinImpact
cmd game downscale 0.7 com.miHoYo.Yuanshen
